...
def run_load_test(database_url: str, concurrent_workers=50, decrements=200, increments=50, initial_qty=100):
...
if __name__ == '__main__':
    ...
    summary = run_load_test(DB_URL, concurrent_workers=workers, decrements=decrements, increments=increments, initial_qty=initial_qty)
    print('\nSummary:')
