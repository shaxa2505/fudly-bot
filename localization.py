...
Совет: товары с фото продаются лучше""",
        ...
        "cart_payment_click_unavailable": "Click временно недоступен. Выберите другой способ.",
...
Menyu pastda.""",
        ...
        "cart_payment_click_unavailable": "Click vaqtincha mavjud emas. Boshqa usulni tanlang.",
