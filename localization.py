...
Нажмите /start.""",
        ...
        "paid_click_reject_blocked": "Оплаченный заказ Click нельзя отклонить или отменить. Свяжитесь с поддержкой.",
...
/start bosing.""",
        ...
        "paid_click_reject_blocked": "Click orqali to'langan buyurtmani rad etib yoki bekor qilib bo'lmaydi. Qo'llab-quvvatlashga murojaat qiling.",
