...
💡 Совет: товары с фото продаются в 3 раза лучше""""",
        ...
        "phone_saved": "? ??????? ????????!",
        "registration_resume_cart": "????????? ?????????? ??????? ???? ??????? ??? ??????.",
        "registration_continue_offers": "?????????? ???????? ???????????",
        "registration_continue_button": "? ??????????",
        "registration_continue_prompt": "????????, ??? ?????? ?????? ???????:",
        "registration_choose_action": "??? ???????:",
        "registration_city_title": "???????? ??? ?????",
        "registration_city_hint": "??????? ?????????? ?????",
        "registration_complete_personal": "? <b>??????!</b>\n\n????? ??????????, {name}!\n??? ?????: {city}\n\n??? ????? ??????:\n? <b>????????????</b> ? ?????? ?? 70%\n? <b>??????</b> ? ??????? ??????????\n? <b>???????</b> ? ??????? ???????",
        "city_selected": "? ????? ??????: {city}",
        "city_changed_confirm": "? ????? ??????? ?? <b>{city}</b>",
        "cart_order_created_menu_hint": "??????????? ? ????.",
        "cart_order_created_codes": "?? ???: {codes}",
        "cart_order_created_ids": "?? ?????: {ids}",
        "cart_order_created_title": "? ????? ??????",
        "cart_clear_button": "???????? ???????",
        "cart_back_button": "?????",
        "cart_confirm_button": "???????????",
        "cart_delivery_button": "????????",
        "cart_pickup_button": "?????????",
        "cart_grand_total_label": "?????",
        "cart_delivery_label": "????????",
        "cart_delivery_address_prompt": "?? ??????? ????? ????????:",
        "cart_delivery_min_order": "? ??????????? ????? ????????: {min} {currency}\n??? ?????: {total} {currency}\n\n??????????, ???????? ??? ?????? ??? ???????? ?????????.",
        "cart_delivery_data_lost": "? ?????? ??????? ???????",
        "cart_delivery_address_too_short": "? ????? ??????? ????????",
        "cart_delivery_payment_prompt": "???????? ?????? ??????:",
        "cart_delivery_products_title": "??????",
        "cart_delivery_address_label": "?????",
        "cart_delivery_payment_click": "?? Click",
        "cart_delivery_payment_card": "?? ?????",
        "cart_delivery_back_button": "? ?????",
        "cart_add_price_label": "????",
        "cart_add_quantity_label": "??????????",
        "cart_add_stock_label": "? ???????",
        "cart_add_expiry_label": "???? ????????",
        "cart_add_total_label": "?????",
        "cart_add_confirm_button": "? ???????? ? ???????",
        "cart_add_cancel_button": "? ??????",
        "cart_add_out_of_stock": "? ????? ??????????",
        "cart_add_popup": "? ?????????! ? ???????: {count}",
        "cart_add_hint_hot": "? ????? ???????? ? ???????.\n?? ?????? ??????? ??????? ??? ????????? ? ??????.",
        "cart_add_hint_search": "? ????? ???????? ? ???????.\n?? ?????? ??????? ??????? ??? ????????? ? ???????????.",
        "store_not_found": "? ??????? ?? ??????",
        "store_offers_list_title": "??????:",
        "store_offers_stock_label": "? ???????",
        "next_page": "?? ??????",
        "cart_payment_card_title": "?? ???????? ??????:",
        "cart_payment_amount_label": "?????",
        "cart_payment_card_label": "?????",
        "cart_payment_holder_label": "??????????",
        "cart_payment_receipt_hint": "????????? ???????? ????",
        "cart_payment_cancel_button": "? ??????",
        "cart_payment_data_missing": "? ?????? ?????? ???????????",
        "cart_payment_click_unavailable": "? Click ???????? ??????????. ??????????, ???????? ??????.",
        "cart_payment_select_title": "???????? ?????? ??????",
        "cart_payment_service_unavailable": "? ?????? ??????? ??????????",
        "cart_payment_order_failed": "? ?? ??????? ??????? ?????",
        "cart_payment_pending_confirmation": "? ????????? ????????????? ??????...",
        "cart_payment_admin_title": "?? ????? ??? (???????)",
        "cart_payment_admin_order": "?????",
        "cart_payment_admin_items": "??????",
        "cart_payment_admin_total": "?????",
        "cart_payment_admin_address": "?????",
        "cart_payment_admin_customer": "??????",
        "cart_payment_admin_phone": "???????",
        "admin_confirm_payment_button": "? ???????????",
        "admin_reject_payment_button": "? ?????????",
        "admin_db_error": "? ?????? ???? ??????",
        "admin_order_not_found": "? ????? ?? ??????",
        "admin_order_already_processed": "? ????? ??? ????????? (??????: {status})",
        "admin_service_unavailable": "? ?????? ??????? ??????????",
        "admin_payment_processing_error": "? ?? ??????? ?????????? ??????",
        "admin_payment_confirmed": "? ?????? ????????????",
        "admin_payment_rejected": "? ?????? ?????????",
        "admin_payment_confirmed_customer": "? <b>?????? ????????????!</b>\n\n?? ????? #{order_id}\n?? {store_name}\n\n???????? ????????????? ????????.",
        "admin_payment_rejected_customer": "? <b>?????? ?? ????????????</b>\n\n?? ????? #{order_id}\n\n??????????, ????????? ? ??????????.",
        "admin_payment_confirmed_caption": "? <b>?????? ??????????:</b> {admin_name}",
        "admin_payment_rejected_caption": "? <b>?????? ????????:</b> {admin_name}",
        "cart_payment_canceled": "? ?????? ????????",
        "cart_payment_photo_required": "?? ??????????, ????????? ???? ????.",
        "cart_payment_photo_already_received": "? ??? ??? ???????. ???????? ?????????????.",
        "cart_total_label": "?????",
        "cart_order_title": "?????",
        "cart_single_store_only": "????? ????? ???????? ?????? ?? ?????? ????????",
        "cart_phone_required": "??? ?????????? ?????? ??????? ????? ????????",
        "cart_low_stock_hint": "????? ?????????????! ??????????? ???????? ????? ??????.",
        "cart_low_stock_item": "? {title}: ???????? ?????? {max} {unit}",
        "cart_empty_alert": "??????? ?????",
        "cart_empty": "?? <b>??????? ?????</b>\n\n???????? ?????? ?? ????????.",
        "cart_cleared": "??????? ???????",
        "cart_title": "???????",
...
👇 Ro'yxatdan tanlang""""",
        ...
        "registration_resume_cart": "Endi <Savat> ni ochib, <Buyurtma berish> ni qayta bosing.",
        "registration_continue_offers": "Aksiyalar orqali davom eting",
        "registration_continue_button": "? Davom ettirish",
        "registration_continue_prompt": "Davom etish uchun tugmani bosing:",
        "registration_choose_action": "?? Tanlang:",
        "registration_city_title": "Shahringizni tanlang",
        "registration_city_hint": "Yaqin takliflarni ko'rsatamiz",
                "registration_complete_personal": """""Tayyor!

Xush kelibsiz, {name}!
Shahar: {city}

Nimalar qilish mumkin:
- Bron qilish ? 70% gacha chegirma
- Buyurtmalar ? tezkor rasmiylashtirish
- Profil ? xaridlar tarixi""""",
        "city_selected": "? Shahar tanlandi: {city}",
        "city_changed_confirm": "? Shahar <b>{city}</b>ga o'zgartirildi",
        "cart_order_created_menu_hint": "Menyudan davom eting.",
        "cart_order_created_codes": "?? Kod: {codes}",
        "cart_order_created_ids": "?? Raqam: {ids}",
        "cart_order_created_title": "? Buyurtma yaratildi",
        "cart_clear_button": "Savatni tozalash",
        "cart_back_button": "Orqaga",
        "cart_confirm_button": "Tasdiqlash",
        "cart_delivery_button": "Yetkazish",
        "cart_pickup_button": "O'zim olaman",
        "cart_grand_total_label": "To'lov",
        "cart_delivery_label": "Yetkazish",
        "cart_delivery_address_prompt": "?? Yetkazish manzilini kiriting:",
        "cart_delivery_min_order": "? Yetkazib berish uchun minimal buyurtma: {min} {currency}\nSizning buyurtmangiz: {total} {currency}\n\nIltimos, ko'proq mahsulot qo'shing yoki olib ketishni tanlang.",
        "cart_delivery_data_lost": "? Savat ma'lumotlari yo'qoldi",
        ...
        "cart_add_stock_label": "Omborda",
        "cart_add_expiry_label": "Yaroqlilik muddati",
        "cart_add_total_label": "JAMI",
        "cart_add_confirm_button": "? Savatga qo'shish",
        "cart_add_cancel_button": "? Bekor qilish",
        "cart_add_out_of_stock": "? Mahsulot tugadi",
        "cart_add_popup": "? Qo'shildi! Savatda: {count}",
        "cart_add_hint_hot": "? Mahsulot savatga qo'shildi.\nSavatni ochishingiz yoki aksiyalarga qaytishingiz mumkin.",
        "cart_add_hint_search": "? Mahsulot savatga qo'shildi.\nSavatni ochishingiz yoki natijalarga qaytishingiz mumkin.",
        "store_not_found": "? Do'kon topilmadi",
        "store_offers_list_title": "Mahsulotlar:",
        "store_offers_stock_label": "Omborda",
        "next_page": "?? Oldinga",
        "cart_payment_card_title": "?? Kartaga o'tkazing:",
        "cart_payment_amount_label": "Summa",
        "cart_payment_card_label": "Karta",
        "cart_payment_holder_label": "Qabul qiluvchi",
        "cart_payment_receipt_hint": "Chek skrinshotini yuboring",
        "cart_payment_cancel_button": "? Bekor qilish",
        "cart_payment_data_missing": "? To'lov ma'lumotlari yo'q",
        "cart_payment_click_unavailable": "? Click vaqtincha ishlamayapti. Iltimos, karta orqali to'lang.",
        "cart_payment_select_title": "To'lov usulini tanlang",
        "cart_payment_service_unavailable": "? Buyurtma xizmati mavjud emas",
        "cart_payment_order_failed": "? Buyurtma yaratib bo'lmadi",
        "cart_payment_pending_confirmation": "? To'lov tasdiqlanishi kutilmoqda...",
        "cart_payment_admin_title": "?? Yangi chek (savat)",
        "cart_payment_admin_order": "Buyurtma",
        "cart_payment_admin_items": "Mahsulotlar",
        "cart_payment_admin_total": "Jami",
        "cart_payment_admin_address": "Manzil",
        "cart_payment_admin_customer": "Mijoz",
        "cart_payment_admin_phone": "Telefon",
        "admin_confirm_payment_button": "? Tasdiqlash",
        "admin_db_error": "? Ma'lumotlar bazasi xatosi",
        "admin_order_not_found": "? Buyurtma topilmadi",
        "admin_order_already_processed": "? Buyurtma allaqachon ko?rib chiqilgan (status: {status})",
        "admin_service_unavailable": "? Buyurtma xizmati mavjud emas",
        "admin_payment_processing_error": "? To?lovni qayta ishlash muvaffaqiyatsiz",
        "admin_payment_confirmed": "? To?lov tasdiqlandi",
        "admin_payment_rejected": "? To?lov rad etildi",
        "admin_payment_confirmed_customer": "? <b>To?lov tasdiqlandi!</b>\n\n?? Buyurtma #{order_id}\n?? {store_name}\n\nDo?kon tasdig?ini kuting.",
        "admin_payment_rejected_customer": "? <b>To?lov tasdiqlanmadi</b>\n\n?? Buyurtma #{order_id}\n\nIltimos, qo?llab-quvvatlashga murojaat qiling.",
        "admin_payment_confirmed_caption": "? <b>To?lovni tasdiqladi:</b> {admin_name}",
        "admin_payment_rejected_caption": "? <b>To?lovni rad etdi:</b> {admin_name}",
        "admin_reject_payment_button": "? Rad etish",
        "cart_payment_canceled": "? To'lov bekor qilindi",
        "cart_payment_photo_required": "?? Iltimos, ??? rasmini yuboring.",
        "cart_payment_photo_already_received": "? Chek qabul qilindi. Tasdiqlanishi kutilmoqda.",
        "cart_delivery_min_order": """? Yetkazib berish uchun minimal buyurtma: {min} {currency}
Sizning buyurtmangiz: {total} {currency}
...
Iltimos, ko'proq mahsulot qo'shing yoki olib ketishni tanlang.""",
        ...
        "cart_single_store_only": "Faqat bitta do'kondan buyurtma berish mumkin",
        "cart_phone_required": "?? Buyurtma berish uchun telefon raqamingizni kiriting",
        "cart_low_stock_hint": "Mahsulot tugayapti! Tezroq buyurtma berishni tavsiya qilamiz.",
