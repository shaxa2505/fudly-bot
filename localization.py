...
💡 Совет: товары с фото продаются в 3 раза лучше""""",
        ...
        "registration_continue_offers": "Предложения уже готовы",
        "registration_continue_button": "📦 Продолжить",
        "registration_continue_prompt": "Отлично, всё уже было готово:",
        "registration_choose_action": "Выберите действие:",
        "registration_city_title": "Выберите ваш город",
        "registration_city_hint": "Ташкент, Самарканд, Бухара",
...
Вам теперь доступны:
🛍 <b>Предложения</b> — скидки до 70%
⭐ <b>Избранное</b> — быстрый доступ
📦 <b>Заказы</b> — история покупок""",
        "city_selected": "📍 Ваш город: {city}",
...
??????????, ???????? ??? ?????? ??? ???????? ??????.""? Yetkazib berish uchun minimal buyurtma: {min} {currency}
