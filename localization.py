...
Меню ниже.""",
        ...
        "hot_offers_subtitle": "Выберите раздел.",
        "select_by_number": "Введите номер товара.",
...
💡 Совет: товары с фото продаются в 3 раза лучше""",
        ...
        "cart_order_created_menu_hint": "Откройте из меню.",
        "cart_single_store_only": "В корзине могут быть товары только из одного магазина",
        "cart_phone_required": "Для оформления заказа нужен номер телефона",
        "cart_low_stock_hint": "Ограниченное количество.",
        ...
        "cart_add_confirm_button": "Добавить в корзину",
        "cart_add_cancel_button": "Отмена",
        "cart_add_out_of_stock": "Нет в наличии",
        "cart_add_popup": "Добавлено! В корзине: {count}",
        "cart_add_hint_hot": "Товар добавлен в корзину.\nМожете продолжить покупки или оформить заказ.",
        "cart_add_hint_search": "Товар добавлен в корзину.\nМожете продолжить покупки или оформить заказ.",
        "cart_updated_notice": "🛒 Корзина обновлена:",
        "cart_item_removed": "❌ {title} — товара нет, удалён из корзины.",
        "cart_item_qty_updated": "⚠ {title} — доступно только {qty} {unit}, количество обновлено.",
        "cart_item_price_updated": "ℹ {title} — новая цена {price} {currency}.",
        "cart_delivery_unavailable": "⚠ Доставка для этого магазина сейчас недоступна.",
        "cart_confirm_in_progress": "⏳ Заказ уже оформляется, подождите.",
        "cart_delivery_address_prompt": "Адрес доставки:",
        ...
        "cart_payment_photo_already_received": "Фото чека уже получено. Ожидайте подтверждения.",
        ...
        "cart_payment_admin_title": "💳 Новый платёж",
...
Menyu pastda.""",
        ...
        "cart_empty_cta": "Mahsulotlarga o'tish",
        ...
        "cart_order_created_menu_hint": "Menyudan oching.",
        ...
        "cart_low_stock_hint": "Cheklangan miqdor.",
        ...
        "cart_add_hint_hot": "Mahsulot savatga qo'shildi.\nXarid qilishni davom ettiring yoki buyurtma bering.",
        ...
        "cart_item_price_updated": "ℹ {title} — yangi narx {price} {currency}.",
        "cart_delivery_unavailable": "⚠ Bu do'konda yetkazib berish hozircha mavjud emas.",
        "cart_confirm_in_progress": "⏳ Buyurtma allaqachon rasmiylashtirilmoqda, kuting.",
        "cart_delivery_address_prompt": "Yetkazib berish manzili:",
        ...
        "cart_payment_card_title": "Karta ma'lumotlarini kiriting:",
        "cart_payment_amount_label": "Summa",
        "cart_payment_card_label": "Karta",
        "cart_payment_holder_label": "Karta egasi",
        ...
        "cart_payment_photo_already_received": "Chek rasmi allaqachon olingan. Tasdiqlashni kuting.",
        # Takliflar
        ...
        "hot_offers_subtitle": "Bo'limni tanlang.",
