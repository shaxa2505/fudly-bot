...
💰 <b>Экономьте до 70%</b> на качественных товарах
...
<b>Зачем это нужно:</b>
✓ Магазин сможет связаться с вами
✓ Уведомления о статусе заказа
✓ Подтверждение бронирований

<i>Нажмите кнопку "Поделиться номером" ниже</i> 👇''',
...
✓ Точные адреса для самовывоза

<i>Выберите город из списка ниже</i> 👇''',
        
        'registration_complete': '''🎊 <b>Регистрация завершена!</b>

<b>🔥 Что попробовать сначала:</b>

1️⃣ <b>Горячее</b> — товары с самыми большими скидками
   Обновляется каждый день!

2️⃣ <b>Do'konlar</b> — все магазины в вашем городе
   Выбирайте по категориям

3️⃣ <b>Поиск</b> — найдите нужный товар
   Например: "хлеб", "молоко", "йогурт"

💡 <b>Совет:</b> Проверяйте раздел "Горячее" каждый день — там появляются новые предложения с максимальными скидками!

<i>Готовы экономить? Вперёд!</i> 🚀''',
...
<b>Шаг 1 из 2: Укажите количество</b>
