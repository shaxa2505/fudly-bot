...
def build_order_card_text(
    ...
    price_label = "Narx" if lang == "uz" else "Цена"
    was_label = "Avval" if lang == "uz" else "Было"
    ...
    address_label = "Manzil" if lang == "uz" else "Адрес"
    ...
    if delivery_enabled:
        ...
        if not delivery_method:
            hint = (
                ...
                if lang == "uz"
                else "Выберите способ получения ниже."
            )
