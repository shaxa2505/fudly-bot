...
5. **Two mini apps** - Partner Panel и Client App
...
```python
# Файл 1: handlers/seller/order_management.py:39
...
#   - reg_city_ → store_reg_city_ / user_reg_city_ / profile_change_city_
...
railway add redis
# Получить REDIS_URL: redis://default:xxx@containers-us-west-xx.railway.app:6379
...
# @BotFather → /mybots → Choose bot → Payments
...
**🟡 Sprint 2 (2 недели):**
5. Database migrations → Alembic only
