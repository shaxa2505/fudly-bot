...
class Booking(BaseModel):
    ...
    booking_id: Optional[int] = Field(None, description="Booking ID (auto-generated)")
    ...
    created_at: Optional[datetime] = Field(None, description="Booking creation time")
    completed_at: Optional[datetime] = Field(None, description="Booking completion time")
