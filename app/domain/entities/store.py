...
from app.domain.value_objects import StoreStatus, BusinessCategory


class Store(BaseModel):
    """Store entity with type-safe fields."""
    
    store_id: Optional[int] = Field(None, description="Store ID (auto-generated)")
    ...
    description: Optional[str] = Field(None, max_length=500, description="Store description")
